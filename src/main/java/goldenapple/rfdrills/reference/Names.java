...
public class Names {
    ...
    public static final String[] COMPONENTS_EIO = { "basic_motor", "advanced_motor", "resonating_crystal",
        "soularium_nugget", "dark_soularium_nugget", "destructive_crystal", "earthshaking_crystal" };
