...
public class MiscUtil {
    ...
    public static boolean shouldModeShiftClick(IEnergyTool tool) {
        if (tool.getModType() == EnumModType.TE && ConfigHandler.modeShiftClickTE) return true;
        else if (tool.getModType() == EnumModType.EIO && ConfigHandler.modeShiftClickEIO) return true;
