...
public class ModRecipes {
    ...
    private static void initTE() {
        ItemStack motorLeadstone = new ItemStack(ModItems.componentTE, 1, Metadata.MOTOR_LEADSTONE);
        ...
        ThermalExpansionHelper.addTransposerFill(
            ...
            motorRedstoneFrame,
            motorRedstone,
            FluidRegistry.getFluidStack("redstone", 4000),
            false);
        ...
        // Leadstone drill
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ModItems.leadstoneDrill,
                " i ",
                "iMi",
                "ICI",
                'I',
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                capacitorLeadstone,
                'M',
                motorLeadstone).setMirrored(true));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorHardened,
                'D',
                new ItemStack(ModItems.leadstoneDrill)));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorHardened,
                'S',
                new ItemStack(ModItems.leadstoneChainsaw)).setMirrored(true));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorRedstone,
                'D',
                new ItemStack(ModItems.hardenedDrill)));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorRedstone,
                'S',
                new ItemStack(ModItems.hardenedChainsaw)).setMirrored(true));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorResonant,
                'D',
                new ItemStack(ModItems.redstoneDrill)));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorResonant,
                'S',
                new ItemStack(ModItems.redstoneChainsaw)).setMirrored(true));
    ...
    private static void initEIO() {
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                motorAdvanced,
                'S',
                ModItems.basicChainsaw).setMirrored(true));
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                ModItems.advancedDrill,
                'C',
                ModItems.advancedChainsaw).setMirrored(true));
        ...
        // Resonating Crystal
        GameRegistry.addRecipe(
            new ShapedOreRecipe(resonatingCrystal, "nnn", "nGn", "nnn", 'n', "nuggetDarkSoularium", 'G', "gemDiamond"));

        // Destructive Crystal
        EnderIOCompat
            .addSoulBinderRecipe("Destructive Crystal", 100000, 10, "Creeper", resonatingCrystal, destructiveCrystal);

        // Earthshaking Crystal
        EnderIOCompat
            .addSoulBinderRecipe("Earthshaking Crystal", 200000, 15, "Ghast", destructiveCrystal, earthshakingCrystal);
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                capacitorBasic,
                's',
                "itemSilicon").setMirrored(true));
    }

    private static void initRArs() {
        boolean useSJReplacement = !RFDrills.isRArsLoaded && SimplyJetpacksCompat.integratesTE();
        if (useSJReplacement) LogHelper
            .info("Redstone Arsenal not found but Simply Jetpacks and TE are installed! Adding alternative items...");

        ItemStack obsidianRod = useSJReplacement ? new ItemStack(ModItems.replacementRA1, 1, Metadata.OBSIDIAN_ROD)
            : new ItemStack(GameRegistry.findItem("RedstoneArsenal", "material"), 1, 192);
        ItemStack fluxRod = useSJReplacement ? new ItemStack(ModItems.replacementRA1, 1, Metadata.FLUX_OBSIDIAN_ROD)
            : new ItemStack(GameRegistry.findItem("RedstoneArsenal", "material"), 1, 193);
        ItemStack fluxArmorPlate = useSJReplacement
            ? new ItemStack(GameRegistry.findItem("simplyjetpacks", "components"), 1, 68)
            : new ItemStack(GameRegistry.findItem("RedstoneArsenal", "material"), 1, 128);
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                "ingotElectrumFlux",
                'c',
                "dustCryotheum").setMirrored(true));

        // Fluctuating Core Frame
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                fluctuatingCoreFrame,
                "eFe",
                "FGF",
                "eCe",
                'e',
        ...
        ThermalExpansionHelper.addTransposerFill(
            ...
            fluctuatingCoreFrame,
            fluctuatingCore,
            FluidRegistry.getFluidStack("cryotheum", 8000),
            false);
        if (RFDrills.isSJLoaded) {
            GameRegistry.addRecipe(
                new ShapedOreRecipe(
        ...
        if (useSJReplacement) {
            // Obsidian Rod
            GameRegistry.addRecipe(
                new ShapedOreRecipe(obsidianRod, "  o", " b ", "o  ", 'o', "dustObsidian", 'b', Items.blaze_powder)
                    .setMirrored(true));

            // Infused Obsidian Rod
            GameRegistry.addRecipe(
                new ShapedOreRecipe(fluxRod, "  G", " R ", "G  ", 'R', obsidianRod, 'G', "gemCrystalFlux")
                    .setMirrored(true));
        }
        ...
        GameRegistry.addRecipe(
            new ShapedUpgradeRecipe(
                ...
                ModItems.resonantChainsaw,
                'F',
                fluctuatingCore).setMirrored(true));
